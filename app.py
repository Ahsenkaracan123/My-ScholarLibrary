...
def add_paper():
    if request.method=="POST":
        ...
        db.execute(db.execute("INSERT INTO papers (user_id, title, authors, year, status, tldr, tags, pdf_path) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",session["user_id"],title,authors,year,status,tldr,tags,pdf_path)
